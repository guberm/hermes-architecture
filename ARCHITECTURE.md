...
> Public-safe architecture snapshot generated at `2026-08-27T06:15:12-04:00`.
>
...
|---|---|---|
| Scheduled tasks / cron | 79 jobs; 39 no-agent script jobs; 0 agent-backed jobs | Exact private task names are grouped by category. |
