...
> Public-safe architecture snapshot generated at `2026-08-12T06:15:53-04:00`.
>
...
|---|---|---|
| Scheduled tasks / cron | 80 jobs; 37 no-agent script jobs; 0 agent-backed jobs | Exact private task names are grouped by category. |
